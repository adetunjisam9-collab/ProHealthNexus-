...
>
  ...
  <div ref={notifRef} style={{ position: 'relative' }}>
    ...
    >
      <i className="fa-solid fa-bell" style={{ fontSize: '16px', color: darkMode ? '#e2e8f0' : '#374151' }}></i>
    ...
    {showNotifications && (
      <div style={{
        ...
        background: darkMode ? '#0f172a' : 'white', borderRadius: '16px',
...
color: 'white', fontWeight: '700', fontSize: '13px'
      ...
      <div style={{ textAlign: 'left' }}>
        <div style={{ fontSize: '13px', fontWeight: '600', color: '#1e3a5f' }}>Dr. {user.full_name.split(' ')[0]}</div>
    ...
    {showAvatarMenu && (
      <div style={{
        ...
        background: darkMode ? '#0f172a' : 'white', borderRadius: '14px',
        boxShadow: '0 20px 60px rgba(0,0,0,0.12)', zIndex: 200,
        border: '1px solid #f3f4f6', overflow: 'hidden'
      }}>
        <div style={{ padding: '12px 16px', borderBottom: '1px solid #f3f4f6' }}>
          <div style={{ fontSize: '13px', fontWeight: '600', color: '#1e3a5f' }}>Dr. {user.full_name}</div>
          <div style={{ fontSize: '11px', color: '#9ca3af', textTransform: 'capitalize' }}>{user.role}</div>
        </div>
        {[
